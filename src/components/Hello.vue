...
<div class="h-screen py-48 bg">
  ...
  <div class="w-6/12 absolute top-1/4 left-1/4 z-20">
    ...
    <p class="text-white text-3xl mt-12 tracking-wider">Chiptune and electronic music composer</p>
    <p class="text-gray-100 text-lg mt-2">Music & sound design for games, videos, animations.</p>
    <button class="shadow-lg bg-red-500 rounded-full py-2 px-4 text-white text-2xl font-semibold mt-4 hover:bg-red-400">
      <i class="fab fa-youtube m-1"></i>
      Watch Showreel !
    </button>
  </div>
  <div class="text-white text-6xl absolute bottom-0 p-4">
    <i class="fas fa-arrow-down animate-pulse"></i>
  </div>
</div>
</template>
<script>
